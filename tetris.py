...
def pastel_color():
    """Generates a random pastel color in RGB format."""
    r = random.randint(150, 255) # High brightness
    g = random.randint(150, 255) # High brightness
    b = random.randint(150, 255) # High brightness
    return (r, g, b)

class Tetromino:
    def __init__(self, x, y, shape): # Corrected __init__
        self.x = x
        self.y = y
        self.shape = shape
        self.color = pastel_color() # Use pastel color generation
        self.rotation = 0
